...
#define RX_WPU                WPUC3
#define RX_ANS                ANSC3
#define RX_SetHigh()    do { LATC3 = 1; } while(0)
#define RX_SetLow()   do { LATC3 = 0; } while(0)
#define RX_Toggle()   do { LATC3 = ~LATC3; } while(0)
#define RX_GetValue()         RC3
#define RX_SetDigitalInput()    do { TRISC3 = 1; } while(0)
#define RX_SetDigitalOutput()   do { TRISC3 = 0; } while(0)

#define RX_SetPullup()    do { WPUC3 = 1; } while(0)
#define RX_ResetPullup()   do { WPUC3 = 0; } while(0)
#define RX_SetAnalogMode()   do { ANSC3 = 1; } while(0)
#define RX_SetDigitalMode()   do { ANSC3 = 0; } while(0)
// get/set TX aliases
